...
@Component({
  selector: 'app-hired-missions-freelancer',
  templateUrl: './hired-missions-freelancer.component.html',
  styleUrls: ['./hired-missions-freelancer.component.css']
})
export class HiredMissionsFreelancerComponent implements OnInit {
   missions;

  constructor(public service : MissionService) { }

  ngOnInit(): void {
    this.service.getHiredMissionsForFreelancer(sessionStorage.getItem('id')).subscribe(value =>
    {
      this.missions=value;
    })
  }
